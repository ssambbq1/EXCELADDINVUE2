...
<TabMain title="1_Fittings"> 

<div class="row">
<div class="column">

<btn @click="myMethod('Valves')">Valves</btn><br>
<div v-if="type == 'Valves'">
<button class="btnSub" v-for="item in valves" :key="item" @click="buttonClick(item.name, item.value)">
{{ item.name }} </button>
</div>

<btn @click="myMethod('Elbows')">Elbows</btn><br>
<div v-if="type == 'Elbows'">
<button class="btnSub" v-for="item in elbows" :key="item" @click="buttonClick(item.name, item.value)">
{{ item.name }} </button>
</div>
...
<TabMain title="Tab 3"> 
  ...
  <form action="/action_page.php">
    ...
    <select id="country" name="country">
      <option value="australia" @click="buttonClick2('australia')">Australia</option>
...
<div id="example-5" class="demo">
    <select v-model="selected1">
      <option v-for="item in data2" :key="item">
